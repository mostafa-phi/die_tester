...
- [Gripper module and station CAD package](docs/cad/README.md) — parametric CadQuery models of the end-face die gripper (STEP/STL per part, assembly with the SMC MHZ2-6D, tolerances, tuning) and of the full station with clearance checks against the microscope and the fiber stages, layout and movement pattern.
