...
| `parallel_yz/` | [Parallel-kinematic YZ platform, concept R01](parallel_yz/README.md): CadQuery plate with two grounded APA60S, converged statics, coupling, gravity and loaded modal (1200 Hz with the 4.9 g holder), APA120S variant (110 µm, 572 Hz), R02 detailed for wire EDM with DXF and shop sheet, R03 minimum-cut two-leg plate (8 millable leaves, 101 µm, 1 % coupling), R04 CNC body with clamped 0.2 mm shim leaves (82 mm, 110 µm, 0.19 %, 575 Hz), R05 machining pass (bonded tabs, R1.0 radii, per-part sheets, bonding jig, lightened frame) with its manufacturing package, renders; the FE chain runs on the CUDA compute host in 4.5 min ([remote/cuda-remote-host.md](parallel_yz/remote/cuda-remote-host.md)); 17-variant monolithic CNC sweep; R06 = the chosen one-piece plate (m8t50k12: 84 mm, 110 µm, 431 Hz, pin stops) with its CNC order package |
