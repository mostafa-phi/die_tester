...
| `thorlabs_HCS013.step`, `thorlabs_HFR001.step`, `thorlabs_HFC005.step`, `thorlabs_AMA010_M.step` | Thorlabs fiber holder stack on each NanoMax platform: HCS013 RMS-threaded flexure stage mount (16022-E0W), HFR001 fiber chuck rotator (10916-E0W), HFC005 Ø1/4" fiber chuck (10907-E0W), AMA010/M cleats (10775-E0W). Placed by `cad/station` `holder_stack()` | thorlabs.com (the fetch script has the direct links) |
| `thorlabs_MB6090_M.step` | Thorlabs MB6090/M aluminium breadboard 600 × 900 × 12.7 (13808-E0W), one solid with the 864 holes. Placed by `cad/station` `table()` | thorlabs.com |
