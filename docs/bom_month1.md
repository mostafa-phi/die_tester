...
| B14 | Axis mounting | 6061 riser bars under the two horizontal actuators (X: 40 × 118 × 300 mm under the base rail, motor overhanging; Y: 60 × 63 × 200 mm), the 60 × 60 × 10 angle bracket carrying the Z actuator on the X table plate, the 8 mm adapter plate and the 25 mm square arm bar on the Z table plate, the tray deck on the Y table plate; 25 mm riser plates under both NanoMax stages (`cad/station`). Print the brackets and the arm in PPA‑CF for the prototype, machine after the trials | McMaster bar stock + in‑house tapping (or 80/20 40 × 120 profile for the X riser) | ~$250 | 1 | X actuator along the exchange direction beside the input NanoMax (centre-line Y −140), outside both fiber corridors; bolt patterns from the LX20 catalog (base Ø3.4 through on a 60 mm pitch, table 4 × M4 on 33.2 × 20). |
