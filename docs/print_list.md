...
| S4 | `arm_6061.stl` (`arm_6061_h.stl`) | One-piece arm: 33-deep adapter block on the Z table, 25 sq bar along +Y, 8 mm end plate over the gripper bracket, extended 38 mm in −X to carry the tray camera (4 × M2 tap-drill) | 72 × 220 × 57 (block 33 × 75 × 57, bar 25 × 25 × 170 from the Z table band to the gripper interface, plate 72 × 40 × 8) | station −X face down: block and bar both rest on the bed, the end plate stands as a wall; no supports | drill 4 × Ø4.5 through the block (counterbored Ø8 from the outside, 25 deep), ream 2 × Ø3 dowels in the block face; tap 4 × M4 in the end plate, ream its 2 × Ø3 dowels, tap 2 × M3 in the plate's −Y edge (live-view boom, S9) | Z table: 4 × M4 × 40 SHCS + 2 × Ø3 × 8 dowels; gripper bracket: 4 × M4 × 16 from below + 2 × Ø3 × 10 dowels | 6061; the bar can be a stock 25 sq bar bolted into a machined block |
| S5 | `tray_deck_6061.stl` | Flat tray deck on the Y table plate; the tray drops onto two Ø3 datum pins (round hole and slot in its X rims) | 160 × 112 × 6 | flat | drill 4 × Ø4.5 + Ø8 counterbore from the top (Y table pattern 20 × 45), ream 2 × Ø3 dowels to the table and the 2 × Ø3 H7 pin holes (press the Ø3 m6 × 10 pins 3.0 mm proud); check the top flat within 0.05 mm, since it sets the ledge plane | Y table: 4 × M4 × 10 SHCS + 2 × Ø3 × 8 dowels; tray: 2 × Ø3 m6 × 10 dowel pins | 6061 plate, or keep the print if the top measures flat |
| S6 | `nanomax_riser_6061.stl` (×2) | 36.5 mm riser plate under each NanoMax, Ø6.6 through holes on the 25 mm grid | 112 × 112 × 36.5 | flat | drill the 16 holes through | M6 × 60 SHCS through the NanoMax slots and the riser into the base plate's taps | **6061 plate, final** (metrology loop); print only for the fit check |
| S8 | `nest_base_plate_6061.stl` | Metrology base plate on the breadboard: NanoMax risers, the nest's KB1X1 and the microscope column stand on it | 190 × 336 × 12 | flat | tap 32 × M6 (riser patterns) + 4 × M6 (column) + 1 × M4 (KB1X1 centre screw); the 14 slots to the breadboard are printed | M6 × 25 SHCS to the breadboard | **6061 plate, final, faced both sides** (it closes the fiber-to-die metrology loop); print only for the fit check |
| S9 | `live_cam_boom_6061.stl` | Boom for the live-view camera off the arm end plate's −Y edge: 6 × 16 foot, 4 mm leg, shelf 51 × 28 × 4 at Z 63…67, 36 × 52 × 4 camera pad tilted 55° from the horizontal | 51 × 43 × 58 | shelf down with support under the pad, or pad face down with support under the shelf; 0.16 layers | drill 2 × Ø3.4 through the foot (M3 into the end plate's edge), open the Ø17 ring hole and tap 4 × M2 in the pad; check the pad angle against a square (35° axis) | end plate: 2 × M3 × 12 SHCS; camera: 4 × M2 × 12 from the camera's back | print is fine (35 g load); 6061 if the view must be repeatable to a pixel after re-mounting |
