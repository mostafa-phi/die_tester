...
| S4 | `arm_6061.stl` (`arm_6061_h.stl`) | One-piece arm: 33-deep adapter block on the Z table, 25 sq bar along +Y, 8 mm end plate over the gripper bracket | 71 × 191 × 57 (block 33 × 71 × 57, bar 25 × 25 × 171) | station −X face down: block and bar both rest on the bed, the end plate stands as a wall; no supports | drill 4 × Ø4.5 through the block (counterbored Ø8 from the outside, 25 deep), ream 2 × Ø3 dowels in the block face; tap 4 × M4 in the end plate, ream its 2 × Ø3 dowels | Z table: 4 × M4 × 40 SHCS + 2 × Ø3 × 8 dowels; gripper bracket: 4 × M4 × 16 from below + 2 × Ø3 × 10 dowels | 6061; the bar can be a stock 25 sq bar bolted into a machined block |
| S5 | `tray_deck_6061.stl` | Tray deck on the Y table plate with a 2 mm locating pocket for the tray (0.2 mm clearance per side) | 148 × 122 × 8 | flat, pocket up | drill 4 × Ø4.5 + Ø8 counterbore from the pocket floor (Y table pattern 20 × 45), ream 2 × Ø3 dowels; check the pocket floor flat within 0.05 mm, since it sets the ledge height | Y table: 4 × M4 × 10 SHCS + 2 × Ø3 × 8 dowels | 6061 plate, or keep the print if the pocket floor measures flat |
